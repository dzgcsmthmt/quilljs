        ...
        (n = {
            9698: function (t, e, n) {
                ...
                var i = n(6003),
                    ...
                    e = n(4850),
                    n = n(5508);
                class l extends i.BlockBlot {
                    cache = {};
                    delta() {
                        return (
                            null == this.cache.delta &&
                                (this.cache.delta = a(this)),
                            this.cache.delta
                        );
                    }
                    deleteAt(t, e) {
                    ...
                    formatAt(t, e, n, r) {
                        e <= 0 ||
                            (this.scroll.query(n, i.Scope.BLOCK)
                    ...
                    insertAt(t, e, n) {
                        if (null != n)
                            return (
                                super.insertAt(t, e, n), void (this.cache = {})
                            );
                        if (0 !== e.length) {
                            const r = e.split("\n"),
                                i = r.shift();
                    ...
                    insertBefore(t, e) {
                        const n = this.children["head"];
                        super.insertBefore(t, e),
                            n instanceof s.A && n.remove(),
                            (this.cache = {});
                    }
                    length() {
                        return (
                ...
                (l.blotName = "block"),
                    (l.tagName = "P"),
                    (l.defaultChild = s.A),
                    (l.allowedChildren = [s.A, e.A, i.EmbedBlot, n.A]);
                class o extends i.EmbedBlot {
                    attach() {
                        super.attach(),
                            (this.attributes = new i.AttributorStore(
                                this.domNode
                            ));
                    }
                    delta() {
                    ...
                    format(t, e) {
                        t = this.scroll.query(t, i.Scope.BLOCK_ATTRIBUTE);
                        null != t && this.attributes.attribute(t, e);
                    }
                    formatAt(t, e, n, r) {
                        this.format(n, r);
                    }
                    insertAt(t, e, n) {
                        if (null != n) super.insertAt(t, e, n);
                        else {
                            const r = e.split("\n"),
                                i = r.pop(),
                                s = r.map((t) => {
                                    const e = this.scroll.create(l.blotName);
                ...
                function a(t) {
                    let n =
                        ...
                        arguments[1];
                    return t
                        .descendants(i.LeafBlot)
                        .reduce(
                            (t, e) =>
                                0 === e.length()
                                    ? t
                                    : t.insert(e.value(), c(e, {}, n)),
                            new (r())()
                        )
                        .insert("\n", c(t));
                }
                ...
                o.scope = i.Scope.BLOCK_BLOT;
            },
            3036: function (t, e, n) {
                "use strict";
                class r extends n(6003).EmbedBlot {
                    static value() {}
                    optimize() {
                ...
                (r.blotName = "break"), (r.tagName = "BR"), (e.A = r);
            },
            580: function (t, e, n) {
                "use strict";
                class r extends n(6003).ContainerBlot {}
                e.A = r;
            },
            4541: function (t, e, n) {
                "use strict";
                ...
                class c extends i.EmbedBlot {
                    ...
                    format(n, r) {
                        if (0 !== this.savedLength) super.format(n, r);
                        else {
                            let t = this,
                                e = 0;
                            for (
                                ;
                                null != t &&
                                t.statics.scope !== i.Scope.BLOCK_BLOT;

                            )
                                (e += t.offset(t.parent)), (t = t.parent);
                            null != t &&
                                ((this.savedLength = c.CONTENTS.length),
                                t.optimize(),
                                t.formatAt(e, c.CONTENTS.length, n, r),
                                (this.savedLength = 0));
                        }
                    }
                    index(t, e) {
                    ...
                    restore() {
                        ...
                        const n = this.prev instanceof a.A ? this.prev : null,
                            r = n ? n.length() : 0,
                            i = this.next instanceof a.A ? this.next : null,
                            e = i ? i.text : "",
                            s = this["textNode"],
                            o = s.data.split(c.CONTENTS).join("");
                        let l;
                        if (((s.data = c.CONTENTS), n))
                            (l = n),
                                (o || i) &&
                                    (n.insertAt(n.length(), o + e),
                                    i && i.remove());
                        else if (i) (l = i).insertAt(0, o);
                        else {
                            const t = document.createTextNode(o);
                            (l = this.scroll.create(t)),
                        ...
                        if ((this.remove(), t)) {
                            const a = (t, e) =>
                                    n && t === n.domNode
                                        ...
                                        ? r + o.length + e
                                        : null,
                                c = a(t.start.node, t.start.offset),
                                e = a(t.end.node, t.end.offset);
                            if (null !== c && null !== e)
                                return {
                                    startNode: l.domNode,
                                    startOffset: c,
                    ...
                    optimize(t) {
                        ...
                        for (; e; ) {
                            if ("A" === e.domNode.tagName) {
                                (this.savedLength = c.CONTENTS.length),
                                    e
                                        .isolate(this.offset(e), this.length())
                                        .unwrap(),
                                    (this.savedLength = 0);
                                break;
                            }
                    ...
                    update(t, e) {
                        t.forEach((t) => {
                            "characterData" !== t.type ||
                                ...
                                ((t = this.restore(t.target)) && (e.range = t));
                        });
                    }
                }
                e.A = o;
            ...
            4850: function (t, e, n) {
                ...
                var i = n(6003),
                    r = n(3036),
                    n = n(5508);
                class s extends i.InlineBlot {
                    static allowedChildren = [s, r.A, i.EmbedBlot, n.A];
                    static order = [
                        "cursor",
                        "inline",
                        "link",
                    ...
                    formatAt(t, e, n, r) {
                        if (
                            ...
                            this.scroll.query(n, i.Scope.BLOT)
                        ) {
            ...
            5508: function (t, e, n) {
                ...
                class r extends n(6003).TextBlot {}
                function i(t) {
                    return t.replace(
                        /[&<>"']/g,
                        (t) =>
            ...
            3729: function (t, e, n) {
                ...
                var i = n(6142),
                    ...
                    d = n(5374);
                function f(t) {
                    return t instanceof a.Ay || t instanceof a.zo;
                }
                function p(t) {
                ...
                class g extends c.ScrollBlot {
                    ...
                    static tagName = "DIV";
                    static defaultChild = a.Ay;
                    static allowedChildren = [a.Ay, a.zo, e.A];
                    constructor(t, e, n) {
                        n = n.emitter;
                        super(t, e),
                            (this.emitter = n),
                    ...
                    emitMount(t) {
                        this.emitter.emit(d.A.events.SCROLL_BLOT_MOUNT, t);
                    }
                    emitUnmount(t) {
                        this.emitter.emit(d.A.events.SCROLL_BLOT_UNMOUNT, t);
                    }
                    emitEmbedUpdate(t, e) {
                        this.emitter.emit(d.A.events.SCROLL_EMBED_UPDATE, t, e);
                    }
                    deleteAt(t, e) {
                        ...
                        if (
                            ...
                            if (n instanceof a.zo || i instanceof a.zo)
                                return void this.optimize();
                            const t =
                                i.children.head instanceof s.A
                                    ? null
                                    : i.children.head;
                            n.moveChildren(i, t), n.remove();
                        }
                        this.optimize();
                    }
                    enable() {
                    ...
                    insertAt(t, e, n) {
                        if (t >= this.length())
                            if (
                                null == n ||
                                null == this.scroll.query(e, c.Scope.BLOCK)
                            ) {
                    ...
                    insertContents(n, r) {
                        const i = this.deltaToRenderBlocks(
                                r.concat(new (h())().insert("\n"))
                            ),
                            s = i.pop();
                        if (null != s) {
                            this.batchStart();
                            ...
                            if (o) {
                                const r =
                                    ...
                                    t =
                                        (r && this.insertAt(e - 1, "\n"),
                                        (0, a.Ji)(this.line(n)[0])),
                                    l =
                                        u.AttributeMap.diff(t, o.attributes) ||
                                        {};
                                Object.keys(l).forEach((t) => {
                                    this.formatAt(e - 1, 1, t, l[t]);
                                }),
                                    (n = e);
                            }
                            let [t, e] = this.children.find(n);
                            i.length &&
                                (t && ((t = t.split(e)), (e = 0)),
                                i.forEach((e) => {
                                    if ("block" === e.type)
                                        ...
                                        const n = this.create(e.key, e.value);
                    ...
                    leaf(t) {
                        ...
                        if (!t) return [null, -1];
                        var [t, e] = t;
                        return t instanceof c.LeafBlot ? [t, e] : [null, -1];
                    }
                    line(t) {
                    ...
                    update(e) {
                        if (this.batch)
                            Array.isArray(e) &&
                                (this.batch = this.batch.concat(e));
                        else {
                            let t = d.A.sources.USER;
                            "string" == typeof e && (t = e),
                                0 <
                                    (e = (e = Array.isArray(e)
                                        ? e
                                        : this.observer.takeRecords()).filter(
                                        (t) => {
                                            (t = t.target),
                                                (t = this.find(t, !0));
                                            return t && !p(t);
                                    ...
                                    this.emitter.emit(
                                        d.A.events.SCROLL_BEFORE_UPDATE,
                                        t,
                                        e
                                    ),
                            ...
                            t.forEach((e) => {
                                ...
                                if (t)
                                    if ("string" == typeof t) {
                                        ...
                                        var n = r[r.length - 1];
                                        n && s.insert(n, e.attributes);
                                    } else {
                                        n = Object.keys(t)[0];
                                        n &&
                                            (this.query(n, c.Scope.INLINE)
                                                ? s.push(e)
                                                : (s.length() &&
                                                      i.push({
                                                          type: "block",
                        ...
                        const r = {},
                            i =
                                (Object.entries(t).forEach((t) => {
                                    var [t, e] = t;
                                    null !=
                                    this.query(t, c.Scope.BLOCK & c.Scope.BLOT)
                                        ? (n = t)
                                        : (r[t] = e);
                                }),
                                this.create(
                            ...
                            s = (this.insertBefore(i, e || void 0), i.length());
                        return (
                ...
                function m(s, t, e) {
                    e.reduce((e, t) => {
                        const n = u.Op.length(t);
                        let r = t.attributes || {};
                        if (null != t.insert)
                            if ("string" == typeof t.insert) {
                                const n = t.insert;
                                s.insertAt(e, n);
                                var [i] = s.descendant(c.LeafBlot, e),
                                    i = (0, a.Ji)(i);
                                r = u.AttributeMap.diff(i, r) || {};
                            } else if ("object" == typeof t.insert) {
                                const n = Object.keys(t.insert)[0];
                                if (null == n) return e;
                                if (
                                    (s.insertAt(e, n, t.insert[n]),
                                    null != s.scroll.query(n, c.Scope.INLINE))
                                ) {
                                    const [t] = s.descendant(c.LeafBlot, e),
                                        n = (0, a.Ji)(t);
                                    r = u.AttributeMap.diff(n, r) || {};
                                }
                            }
                        return (
                            Object.keys(r).forEach((t) => {
                                s.formatAt(e, n, t, r[t]);
                            }),
                            e + n
                        );
                    }, t);
                ...
                class x extends A.A {
                    ...
                    constructor(t, e) {
                        super(t, e),
                            this.quill.on(
                                i.Ay.events.EDITOR_CHANGE,
                                (t, e, n, r) => {
                                    t === i.Ay.events.SELECTION_CHANGE
                                        ? e &&
                                          r !== i.Ay.sources.SILENT &&
                                          (this.currentRange = e)
                                        : t === i.Ay.events.TEXT_CHANGE &&
                                          (this.ignoreChange ||
                    ...
                    record(n, r) {
                        if (0 !== n.ops.length) {
                            ...
                            if (
                                ...
                                const n = this.stack.undo.pop();
                                n && ((t = t.compose(n.delta)), (e = n.range));
                            } else this.lastRecorded = n;
                            0 !== t.length() &&
                                (this.stack.undo.push({ delta: t, range: e }),
                    ...
                    restoreSelection(t) {
                        t.range
                            ...
                            : ((t = (function (t, n) {
                              ...
                              this.quill.setSelection(t, i.Ay.sources.USER));
                    }
                }
                function N(e, t) {
                    let n = t;
                    for (let t = e.length - 1; 0 <= t; --t) {
                        ...
                        (e[t] = {
                            ...
                            0 === e[t].delta.length() && e.splice(t, 1);
                    }
                }
                function E(t, e) {
                    if (!t) return t;
                ...
                class q extends A.A {
                    constructor(r, t) {
                        super(r, t),
                            r.root.addEventListener("drop", (t) => {
                                t.preventDefault();
                                let e = null;
                                if (document.caretRangeFromPoint)
                                    e = document.caretRangeFromPoint(
                                        t.clientX,
                                        t.clientY
                                    );
                                else if (document.caretPositionFromPoint) {
                                    const r = document.caretPositionFromPoint(
                                        t.clientX,
                                        t.clientY
                                    );
                                    (e = document.createRange()).setStart(
                                        ...
                                        e.setEnd(r.offsetNode, r.offset);
                                }
                                var n = e && r.selection.normalizeNative(e);
                                if (n) {
                                    const e = r.selection.normalizedToRange(n);
                                    t.dataTransfer?.files &&
                                        this.upload(e, t.dataTransfer.files);
                                }
                            });
                    }
                    upload(t, e) {
                    ...
                    handler(n, t) {
                        this.quill.scroll.query("image") &&
                            ...
                            Promise.all(t).then((t) => {
                                ...
                                this.quill.updateContents(e, d.A.sources.USER),
                                    this.quill.setSelection(
                                        n.index + t.length,
                                        d.A.sources.SILENT
                                    );
                ...
                class _ extends A.A {
                    constructor(t, e) {
                        super(t, e),
                            ...
                            /Android/i.test(navigator.userAgent) ||
                                t.on(
                                    i.Ay.events.COMPOSITION_BEFORE_START,
                                    () => {
                    ...
                    deleteRange(t) {
                        (0, w.Xo)({ range: t, quill: this.quill });
                    }
                    replaceText(t) {
                        var e,
                            n =
                        ...
                        return (
                            0 !== t.length &&
                            (n
                                ? ((e = this.quill.getFormat(t.index, 1)),
                                  this.deleteRange(t),
                                  this.quill.updateContents(
                                      new (h())().retain(t.index).insert(n, e),
                                      i.Ay.sources.USER
                                  ))
                                : this.deleteRange(t),
                            this.quill.setSelection(
                                ...
                                null !=
                                    (e =
                                        "string" == typeof (e = t).data
                                            ...
                                            : null) &&
                                (n = (n =
                                    this.quill.selection.normalizeNative(n))
                                    ? this.quill.selection.normalizedToRange(n)
                                    : null) &&
                                this.replaceText(n, e) &&
                                t.preventDefault());
                    }
                ...
                var L = _;
                const S = /Mac/i.test(navigator.platform);
                class O extends A.A {
                    isListening = !1;
                    ...
                    handleArrowKeys() {
                        this.quill.keyboard.addBinding({
                            ...
                            shiftKey: null,
                            handler(t, e) {
                                var { line: e, event: n } = e;
                                if (!(e instanceof c.ParentBlot && e.uiNode))
                                    return !0;
                                e =
                                    "rtl" ===
                                    getComputedStyle(e.domNode).direction;
                                return (
                                    !!(
                                        (e && "ArrowRight" !== n.key) ||
                                        (!e && "ArrowLeft" !== n.key)
                    ...
                    handleSelectionChange() {
                        ...
                        if (t) {
                            ...
                            if (!0 === e.collapsed && 0 === e.startOffset) {
                                e = this.quill.scroll.find(e.startContainer);
                                if (e instanceof c.ParentBlot && e.uiNode) {
                                    const n = document.createRange();
                                    n.setStartAfter(e.uiNode),
                                        n.setEndAfter(e.uiNode),
                                        t.removeAllRanges(),
                                        t.addRange(n);
                                }
                            }
            ...
            5374: function (t, e, n) {
                ...
                var e = n(8920),
                    r = n(7356);
                const i = (0, n(6078).A)("quill:events");
                    ...
                    (t) => {
                        document.addEventListener(t, function () {
                            ...
                            Array.from(
                                ...
                                const e = r.A.get(t);
                                e && e.emitter && e.emitter.handleDOM(...n);
                            });
                        });
                    }
                );
                var s = class extends e {
                    ...
                    emit() {
                        for (
                            ...
                            e[n] = arguments[n];
                        return i.log.call(i, ...e), super.emit(...e);
                    }
                    handleDOM(r) {
                        for (
                            var t = arguments.length,
                            ...
                            i[e - 1] = arguments[e];
                        (this.domListeners[r.type] || []).forEach((t) => {
                            let { node: e, handler: n } = t;
                            (r.target !== e && !e.contains(r.target)) ||
                                n(r, ...i);
                        });
                    }
                    listenDOM(t, e, n) {
            ...
            6142: function (B, t, e) {
                ...
                const b = /^[ -~]*$/;
                function y(t, e, n, r) {
                    let i = 3 < arguments.length && void 0 !== r && r;
                    if ("html" in t && "function" == typeof t.html)
                        return t.html(e, n);
                    if (t instanceof m.A)
                        return (0, m.X)(t.value().slice(e, e + n));
                    if (t instanceof f.ParentBlot) {
                        ...
                        const { outerHTML: s, innerHTML: o } = t.domNode,
                            [l, a] = s.split(`>${o}<`);
                        return "<table" === l
                            ? `<table style="border: 1px solid #000;">${f.join(
                                  ""
                              )}<` + a
                            : `${l}>${f.join("")}<` + a;
                    }
                ...
                function A(t, e) {
                    var { index: t, length: n } = t;
                    return new l.Q(t + e, n);
                }
                var s = class {
                        constructor(t) {
                        ...
                        applyDelta(t) {
                            ...
                            return (
                                (function (t) {
                                ...
                                })(e.ops.slice()).reduce((e, n) => {
                                    const r = c.Op.length(n);
                                    let i = n.attributes || {},
                                        s = !1,
                                        o = !1;
                                    if (null != n.insert) {
                                        if (
                                            ...
                                            const r = n.insert,
                                                [a, s] =
                                                    ...
                                                    this.scroll.line(e));
                                            let t = (0, d.A)({}, (0, p.Ji)(a));
                                            if (a instanceof p.Ay) {
                                                const [e] = a.descendant(
                                                    f.LeafBlot,
                                                    s
                                                );
                                                e &&
                                        ...
                                        const l = Object.keys(n.retain)[0];
                                        if (null == l) return e;
                                    ...
                                    Object.keys(i).forEach((t) => {
                                        this.scroll.formatAt(e, r, t, i[t]);
                                    });
                                    var n = s ? 1 : 0,
                                        t = o ? 1 : 0;
                                    return (
                        ...
                        deleteText(t, e) {
                            return (
                                ...
                                this.update(new (u())().retain(t).delete(e))
                            );
                        }
                        formatLine(t, n) {
                            let r =
                        ...
                        formatText(e, n) {
                            let r =
                                2 < arguments.length && void 0 !== arguments[2]
                                    ...
                                    : {};
                            Object.keys(r).forEach((t) => {
                                this.scroll.formatAt(e, n, t, r[t]);
                            });
                            var t = new (u())()
                                .retain(e)
                                .retain(n, (0, i.A)(r));
                        ...
                        insertContents(t, e) {
                            var e = r(e),
                                n = new (u())().retain(t).concat(e);
                            return (
                                this.scroll.insertContents(t, e), this.update(n)
                            );
                        }
                        insertEmbed(t, e, n) {
                            return (
                        ...
                        insertText(e, n) {
                            ...
                            return (
                                ...
                                Object.keys(r).forEach((t) => {
                                    this.scroll.formatAt(e, n.length, t, r[t]);
                                }),
                                this.update(
                                    new (u())().retain(e).insert(n, (0, i.A)(r))
                                )
                            );
                        }
                        isBlank() {
                            ...
                            return (
                                t?.statics.blotName === p.Ay.blotName &&
                                !(1 < t.children.length) &&
                                t.children.head instanceof n.A
                            );
                        }
                        removeFormat(t, e) {
                            ...
                            null != r &&
                                ...
                                (o = r
                                    ...
                                    .slice(i, i + s - 1)
                                    .insert("\n")));
                            (e = this.getContents(t, e + s).diff(
                                new (u())().insert(n).concat(o)
                            )),
                                (t = new (u())().retain(t).concat(e));
                            return this.applyDelta(t);
                        }
                        update(t) {
                            let e =
                                    1 < arguments.length &&
                            ...
                            if (
                                ...
                                e[0].target.data.match(b) &&
                                this.scroll.find(e[0].target)
                            ) {
                                const i = this.scroll.find(e[0].target),
                                    s = (0, p.Ji)(i),
                                    o = i.offset(this.scroll),
                                    h = e[0].oldValue.replace(g.A.CONTENTS, ""),
                                    l = new (u())().insert(h),
                                    a = new (u())().insert(i.value()),
                                    c = n && {
                                        oldRange: A(n.oldRange, -o),
                                        newRange: A(n.newRange, -o),
                                    };
                                (t = new (u())()
                                    .retain(o)
                                    .concat(l.diff(a, c))
                                ...
                                (this.delta = this.getDelta()),
                                    (t && (0, h.A)(r.compose(t), this.delta)) ||
                    ...
                    E = class {
                        ...
                        handleCompositionStart(t) {
                            ...
                            !e ||
                                e instanceof N.A ||
                                (this.emitter.emit(
                                    a.A.events.COMPOSITION_BEFORE_START,
                                    t
                                ),
                                this.scroll.batchStart(),
                                this.emitter.emit(
                                    a.A.events.COMPOSITION_START,
                                    t
                                ),
                                (this.isComposing = !0));
                        }
                        handleCompositionEnd(t) {
                            this.emitter.emit(
                                a.A.events.COMPOSITION_BEFORE_END,
                                t
                            ),
                                this.scroll.batchEnd(),
                                this.emitter.emit(
                                    a.A.events.COMPOSITION_END,
                                    t
                                ),
                                (this.isComposing = !1);
                        }
                ...
                class S {
                    static DEFAULTS = {
                        ...
                        placeholder: "",
                        readOnly: !(f.ParentBlot.uiClass = "ql-ui"),
                        registry: L,
                        theme: "default",
                    };
                    static events = a.A.events;
                    static sources = a.A.sources;
                    ...
                    static register() {
                        if (
                            ...
                            const e =
                                ...
                                t = "attrName" in e ? e.attrName : e.blotName;
                            "string" == typeof t
                                ? this.register("formats/" + t, e, n)
                                : Object.keys(e).forEach((t) => {
                                      this.register(t, e[t], n);
                                  });
                        } else {
                            const r =
                                    arguments.length <= 0
                                ...
                                i =
                                    arguments.length <= 1
                                        ? void 0
                                        : arguments[1],
                                s = !(arguments.length <= 2 || !arguments[2]);
                            null == this.imports[r] ||
                                s ||
                                _.warn(`Overwriting ${r} with`, i),
                                (this.imports[r] = i),
                                (r.startsWith("blots/") ||
                                    r.startsWith("formats/")) &&
                                    i &&
                                    "boolean" != typeof i &&
                                    "abstract" !== i.blotName &&
                                    L.register(i),
                    ...
                    constructor(h) {
                        if (
                            ((this.options = (function (t) {
                                ...
                                var n =
                                    t.theme && t.theme !== S.DEFAULTS.theme
                                        ? S.import("themes/" + t.theme)
                                        : w.A;
                                if (!n)
                                    throw new Error(
                                        `Invalid theme ${t.theme}. Did you register it?`
                                    );
                                const { modules: r, ...i } = S.DEFAULTS,
                                    { modules: s, ...o } = n.DEFAULTS;
                                let l = T(t.modules);
                                null != l &&
                                    l.toolbar &&
                                    l.toolbar.constructor !== Object &&
                                    (l = {
                                        ...l,
                                        toolbar: { container: l.toolbar },
                                    });
                                var a = (0, d.A)({}, T(r), T(s), l),
                                    c = { ...i, ...j(o), ...j(t) };
                                let u = t.registry;
                                return (
                                    u
                                              ...
                                              : c.registry),
                                    {
                                        ...
                                        container: e,
                                        theme: n,
                                        modules: Object.entries(a).reduce(
                                            (t, e) => {
                                                var [e, n] = e;
                                                if (!n) return t;
                                                var r = S.import(
                            ...
                            _.error("Invalid Quill container", h);
                        else {
                            this.options.debug && S.debug(this.options.debug);
                            var t = this.container.innerHTML.trim();
                            this.container.classList.add("ql-container"),
                                (this.container.innerHTML = ""),
                                o.A.set(this.container, this),
                                (this.root = this.addContainer("ql-editor")),
                                this.root.classList.add("ql-blank"),
                                (this.emitter = new a.A());
                            const e = f.ScrollBlot.blotName,
                                n = this.options.registry.query(e);
                            if (!(n && "blotName" in n))
                                throw new Error(
                                    `Cannot initialize Quill without "${e}" blot`
                                );
                            if (
                                ((this.scroll = new n(
                                ...
                                (this.editor = new s(this.scroll)),
                                (this.selection = new l.A(
                                    this.scroll,
                                    this.emitter
                                )),
                                (this.composition = new E(
                                    this.scroll,
                                    this.emitter
                                )),
                                ...
                                this.theme.init(),
                                this.emitter.on(
                                    a.A.events.EDITOR_CHANGE,
                                    (t) => {
                                        t === a.A.events.TEXT_CHANGE &&
                                ...
                                this.emitter.on(
                                    a.A.events.SCROLL_EMBED_UPDATE,
                                    (e, n) => {
                                        ...
                                        C.call(
                                            ...
                                            () => {
                                                var t = new (u())()
                                                    .retain(e.offset(this))
                                                    .retain({
                                                        [e.statics.blotName]: n,
                                                    });
                    ...
                    format(n, r) {
                        ...
                        return C.call(
                            ...
                            () => {
                                ...
                                let e = new (u())();
                                if (null == t) return e;
                                if (this.scroll.query(n, f.Scope.BLOCK))
                                    ...
                                    if (0 === t.length)
                                        return this.selection.format(n, r), e;
                                    e = this.editor.formatText(
                                        t.index,
                                        t.length,
                                        { [n]: r }
                                    );
                                ...
                                return (
                                    this.setSelection(t, a.A.sources.SILENT), e
                                );
                            },
                            t
                        );
                        ...
                        let t =
                            ...
                            e =
                                1 < arguments.length && void 0 !== arguments[1]
                                    ...
                                    : this.getLength() - t;
                        return (
                            ([t, e] = R(t, e)), this.editor.getContents(t, e)
                        );
                    }
                    getFormat() {
                        var t =
                                ...
                                const r = e === u.body,
                                    i = r
                                        ...
                                        : ((s = e),
                                          ...
                                          {
                                              top: o.top,
                                              right: o.left + s.clientWidth * l,
                                              bottom:
                                                  o.top + s.clientHeight * a,
                                              left: o.left,
                                          }),
                                    ...
                                    d = k(
                                        ...
                                        i.left,
                                        i.right,
                                        q(h.scrollPaddingLeft),
                                        q(h.scrollPaddingRight)
                                    ),
                                    f = k(
                                        t.top,
                                        t.bottom,
                                        i.top,
                                        i.bottom,
                                        q(h.scrollPaddingTop),
                                        q(h.scrollPaddingBottom)
                                    );
                                if (d || f)
                                    if (r) u.defaultView?.scrollBy(d, f);
                                    else {
                                        const { scrollLeft: r, scrollTop: i } =
                                                e,
                                            u =
                                                (f && (e.scrollTop += f),
                                                d && (e.scrollLeft += d),
                        ...
                        return C.call(
                            ...
                            () => {
                                ...
                                const t = this.getLength(),
                                    e = this.editor.deleteText(0, t),
                                    n = this.editor.insertContents(0, i),
                                    r = this.editor.deleteText(
                                        this.getLength() - 1,
                                        1
                                    );
                                return e.compose(n).compose(r);
                            },
                            t
                        );
                    }
                    setSelection(t, e, n) {
                        null == t
                            ? this.selection.setRange(null, e || S.sources.API)
                            : (([t, e, , n] = R(t, e, n)),
                              this.selection.setRange(
                                  new l.Q(Math.max(0, t), e),
                                  n
                              ),
                              n !== a.A.sources.SILENT &&
                                  this.scrollSelectionIntoView());
                    }
                    setText(t) {
                        var e =
                    ...
                    updateContents(t) {
                        ...
                        return C.call(
                            this,
                            () => (
                                (t = new (u())(t)), this.editor.applyDelta(t)
                            ),
                            e,
                            !0
                        );
                    ...
                    if (
                        (null != i &&
                            ...
                            null == r
                                ? (i = I(i, o, e))
                                : 0 !== r && (i = I(i, n, r, e)),
                            this.setSelection(i, a.A.sources.SILENT)),
                        0 < o.length())
                    ) {
                        const t = [a.A.events.TEXT_CHANGE, o, s, e];
                    ...
                    return (
                        e && "function" == typeof e.transformPosition
                            ? ([s, o] = [t.index, t.index + t.length].map((t) =>
                                  e.transformPosition(t, r !== a.A.sources.USER)
                              ))
                            : ([s, o] = [t.index, t.index + t.length].map((t) =>
                                  t < e || (t === e && r === a.A.sources.USER)
                                      ? t
                                      : 0 <= i
                                      ? t + i
                                      : Math.max(e, t + i)
            ...
            8298: function (t, e, n) {
                ...
                var s = n(6003),
                    ...
                    o = n(3707),
                    l = n(5374);
                const a = (0, n(6078).A)("quill:selection");
                class r {
                    constructor(t) {
                        var e =
                            1 < arguments.length && void 0 !== arguments[1]
                ...
                e.A = class {
                    constructor(t, e) {
                        (this.emitter = e),
                            ...
                            this.emitter.on(
                                l.A.events.SCROLL_BEFORE_UPDATE,
                                () => {
                                    if (this.hasFocus()) {
                    ...
                    handleComposition() {
                        this.emitter.on(
                            l.A.events.COMPOSITION_BEFORE_START,
                            () => {
                                this.composing = !0;
                            }
                        ),
                            this.emitter.on(l.A.events.COMPOSITION_END, () => {
                                if (
                                    ((this.composing = !1), this.cursor.parent)
                                ) {
                    ...
                    format(t, e) {
                        ...
                        if (
                            null != n &&
                            n.native.collapsed &&
                            !this.scroll.query(t, s.Scope.BLOCK)
                        ) {
                            if (n.start.node !== this.cursor.textNode) {
                                const t = this.scroll.find(n.start.node, !1);
                                if (null == t) return;
                                if (t instanceof s.LeafBlot) {
                    ...
                    rangeToNative(t) {
                        const i = this.scroll.length(),
                            e = (t, e) => {
                                t = Math.min(i - 1, t);
                                const [n, r] = this.scroll.leaf(t);
                                return n ? n.position(r, e) : [null, -1];
                            };
                        return [
                            ...e(t.index, !1),
                    ...
                    update() {
                        ...
                        if (
                            ...
                            const n = [
                                l.A.events.SELECTION_CHANGE,
                                (0, o.A)(this.lastRange),
                                (0, o.A)(e),
                                t,
                            ];
                            this.emitter.emit(l.A.events.EDITOR_CHANGE, ...n),
                                t !== l.A.sources.SILENT &&
                                    this.emitter.emit(...n);
                        }
                    }
                };
            ...
            8276: function (t, e, n) {
                ...
                const r = {
                    ...
                    i = new e.Attributor("align", "align", r),
                    s = new e.ClassAttributor("align", "ql-align", r),
                    o = new e.StyleAttributor("align", "text-align", r);
            },
            9541: function (t, e, n) {
                "use strict";
                n.d(e, {
                ...
                (e = n(6003)), (n = n(8638));
                const r = new e.ClassAttributor("background", "ql-bg", {
                        scope: e.Scope.INLINE,
                    }),
                    i = new n.a2("background", "background-color", {
                        scope: e.Scope.INLINE,
                    });
            },
            9404: function (t, e, n) {
...
${(0, o.X)(this.code(t, e))}
                ...
                (h.blotName = "code"),
                    (h.tagName = "CODE"),
                    (u.blotName = "code-block"),
                    (u.className = "ql-code-block"),
                    (u.tagName = "DIV"),
                    (c.blotName = "code-block-container"),
                    (c.className = "ql-code-block-container"),
                    (c.tagName = "DIV"),
                    (c.allowedChildren = [u]),
                    (u.allowedChildren = [o.A, r.A, i.A]),
            ...
            8638: function (t, e, n) {
                ...
                e = n(6003);
                class r extends e.StyleAttributor {
                    value(t) {
                        let e = super.value(t);
                ...
                const i = new e.ClassAttributor("color", "ql-color", {
                        scope: e.Scope.INLINE,
                    }),
                    s = new r("color", "color", { scope: e.Scope.INLINE });
            },
            7912: function (t, e, n) {
                "use strict";
                n.d(e, {
                ...
                e = n(6003);
                const r = { scope: e.Scope.BLOCK, whitelist: ["rtl"] },
                    i = new e.Attributor("direction", "dir", r),
                    s = new e.ClassAttributor("direction", "ql-direction", r),
                    o = new e.StyleAttributor("direction", "direction", r);
            },
            6772: function (t, e, n) {
                "use strict";
                n.d(e, {
                ...
                const r = {
                    ...
                    i = new e.ClassAttributor("font", "ql-font", r);
                class s extends e.StyleAttributor {
                    value(t) {
                        return super.value(t).replace(/["']/g, "");
                    }
                }
                const o = new s("font", "font-family", r);
            },
            664: function (t, e, n) {
                "use strict";
                n.d(e, {
                ...
                e = n(6003);
                const r = new e.ClassAttributor("size", "ql-size", {
                        scope: e.Scope.INLINE,
                        whitelist: ["small", "large", "huge"],
                    }),
                    i = new e.StyleAttributor("size", "font-size", {
                        scope: e.Scope.INLINE,
            ...
            584: function (t, e, n) {
                ...
                var l = n(6003),
                    ...
                    p = n(664),
                    g = n(8123);
                const m = /font-weight:\s*normal/,
                    b = ["P", "OL", "UL"],
                    y = (t) => t && b.includes(t.tagName),
                    v = /\bmso-list:[^;]*ignore/i,
                    A = /\bmso-list:[^;]*\bl(\d+)/i,
                    ...
                    w = [
                                ...
                                if (
                                    ...
                                    if (
                                        ...
                                        !(i = t).previousElementSibling ||
                                            ...
                                            O(i.previousElementSibling, s) ||
                                            O(i.nextElementSibling, s))
                                    )
                                        return e;
                                    i = (t, e) => {
                                        e = e.replace(/[^\u00a0]/g, "");
                                        return e.length < 1 && t ? " " : e;
                                    };
                                    (r = (r = r
                                        .replace(/\r\n/g, " ")
                                        .replace(/\n/g, " ")).replace(
                        ...
                        [
                            ...
                            function (t, e, n) {
                                const r = n.query(t);
                                if (null == r) return e;
                                if (r.prototype instanceof l.EmbedBlot) {
                                    const e = {},
                                        l = r.value(t);
                                    if (null != l)
                                        return (
                                    ...
                                    (r.prototype instanceof l.BlockBlot &&
                                        !S(e, "\n") &&
                                        e.insert("\n"),
                                    "blotName" in r &&
                                        "formats" in r &&
                                    ...
                                    return L(e, r.blotName, r.formats(t, n), n);
                                return e;
                            },
                        ],
                        [
                            Node.ELEMENT_NODE,
                            function (n, t, r) {
                                const e = l.Attributor.keys(n),
                                    i = l.ClassAttributor.keys(n),
                                    s = l.StyleAttributor.keys(n),
                                    o = {};
                                return (
                                    e
                                        .concat(i)
                        ...
                        [
                            ...
                            function (t, e, r) {
                                const n = {},
                                    i = t.style || {};
                                return (
                                    "italic" === i.fontStyle && (n.italic = !0),
                                    "underline" === i.textDecoration &&
                                        (n.underline = !0),
                                    "line-through" === i.textDecoration &&
                                        (n.strike = !0),
                                    (i.fontWeight?.startsWith("bold") ||
                                        700 <= parseInt(i.fontWeight, 10)) &&
                                        (n.bold = !0),
                                    (e = Object.entries(n).reduce((t, e) => {
                                        var [e, n] = e;
                                        return L(t, e, n, r);
                                    }, e)),
                                    0 < parseFloat(i.textIndent || 0)
                                        ? new (a())().insert("\t").concat(e)
                                        : e
                                );
                            },
                        ],
                        ...
                        [
                            ...
                            function (t, e, n) {
                                const r = t;
                                let i =
                                    "OL" === r.tagName ? "ordered" : "bullet";
                                t = r.getAttribute("data-checked");
                                return L(
                                    e,
                                    "list",
                                    (i = t
                    ...
                    k = [o.Hu, c.s, h.JM, d.VL, f.z, p.r].reduce(
                        (t, e) => ((t[e.keyName] = e), t),
                        {}
                    );
                class _ extends r.A {
                        ...
                        var { html: t, text: e } = t,
                            n =
                                1 < arguments.length && void 0 !== arguments[1]
                                    ...
                                    : {};
                        if (n[u.Ay.blotName])
                            return new (a())().insert(e || "", {
                                [u.Ay.blotName]: n[u.Ay.blotName],
                            });
                        if (!t) return new (a())().insert(e || "", n);
                        const r = this.convertHTML(t);
                        return S(r, "\n") &&
                            (null == r.ops[r.ops.length - 1].attributes ||
                                n.table)
                            ? r.compose(
                                  new (a())().retain(r.length() - 1).delete(1)
                              )
                            : r;
                    }
                    normalizeHTML(t) {
                    ...
                    convertHTML(t) {
                        var t = new DOMParser().parseFromString(t, "text/html"),
                            t = (this.normalizeHTML(t), t.body),
                            e = new WeakMap(),
                            [n, r] = this.prepareMatching(t, e);
                        return j(this.quill.scroll, t, n, r, e);
                    }
                    dangerouslyPasteHTML(t, e) {
                        ...
                        if ("string" == typeof t) {
                            ...
                            this.quill.setContents(n, e),
                                this.quill.setSelection(0, s.Ay.sources.SILENT);
                        } else {
                            const r = this.convert({ html: e, text: "" });
                            this.quill.updateContents(
                                new (a())().retain(t).concat(r),
                                n
                            ),
                                this.quill.setSelection(
                                    t + r.length(),
                    ...
                    onCaptureCopy(t) {
                        ...
                        t.defaultPrevented ||
                            (t.preventDefault(),
                            ([e] = this.quill.selection.getRange()),
                            null != e &&
                                (({ html: n, text: r } = this.onCopy(e, i)),
                        ...
                        if (!e.defaultPrevented && this.quill.isEnabled()) {
                            ...
                            if (null != i) {
                                ...
                                if (!n && !t) {
                                    ...
                                    i && (t = this.normalizeURIList(i));
                                }
                                var r = Array.from(
                                    e.clipboardData?.files || []
                                );
                                if (!n && 0 < r.length)
                                    this.quill.uploader.upload(i, r);
                                else {
                                    if (n && 0 < r.length) {
                                        const e =
                                        ...
                                        if (
                                            1 === e.body.childElementCount &&
                                            "IMG" ===
                                                e.body.firstElementChild
                                                    ?.tagName
                                        )
                    ...
                    onPaste(t, e) {
                        var { text: e, html: n } = e,
                            ...
                            r = this.convert({ text: e, html: n }, r);
                        E.log("onPaste", r, { text: e, html: n });
                        const i = new (a())()
                            .retain(t.index)
                            .delete(t.length)
                            .concat(r);
                        this.quill.updateContents(i, s.Ay.sources.USER),
                            this.quill.setSelection(
                                i.length() - t.length,
                                s.Ay.sources.SILENT
                            ),
                ...
                function S(e, n) {
                    let r = "";
                    for (
                        let t = e.ops.length - 1;
                        0 <= t && r.length < n.length;
                        --t
                    ) {
                        const n = e.ops[t];
                    ...
                    return r.slice(-1 * n.length) === n;
                }
                function O(t, e) {
                    if (t instanceof Element)
                        return (
                            (e = e.query(t)),
                            !(e && e.prototype instanceof l.EmbedBlot) &&
                                [
                                    "address",
                                    "article",
                                    "blockquote",
                ...
                const T = new WeakMap();
                function j(r, i, s, o, l) {
                    return i.nodeType === i.TEXT_NODE
                        ? o.reduce((t, e) => e(i, t, r), new (a())())
                        : i.nodeType === i.ELEMENT_NODE
                        ? Array.from(i.childNodes || []).reduce((t, n) => {
                              let e = j(r, n, s, o, l);
                              return (
                                  n.nodeType === i.ELEMENT_NODE &&
                                      ((e = s.reduce((t, e) => e(n, t, r), e)),
                                      (e = (l.get(n) || []).reduce(
                                          (t, e) => e(n, t, r),
                                          e
                                      ))),
                ...
                function R(e, n, r) {
                    if (!S(n, "\n")) {
                        if (
                            ...
                            return n.insert("\n");
                        if (0 < n.length() && e.nextSibling) {
                            let t = e.nextSibling;
                            for (; null != t; ) {
                                if (O(t, r)) return n.insert("\n");
                                const e = r.query(t);
                                if (e && e.prototype instanceof i.zo)
                                    return n.insert("\n");
                                t = t.firstChild;
                            }
                        }
            ...
            8123: function (t, e, n) {
                ...
                class m extends n.A {
                    ...
                    addBinding(t) {
                        ...
                        const r = (function (t) {
                            ...
                            return (
                                t.shortKey &&
                                    ((t[l] = t.shortKey), delete t.shortKey),
                                t
                            );
                        })(t);
                        null != r
                            ? ("function" == typeof e && (e = { handler: e }),
                              ...
                              (Array.isArray(r.key) ? r.key : [r.key]).forEach(
                                  (t) => {
                                      t = { ...r, key: t, ...e, ...n };
                                      (this.bindings[t.key] =
                                          this.bindings[t.key] || []),
                    ...
                    listen() {
                        this.quill.root.addEventListener("keydown", (e) => {
                            if (
                                ...
                                const n = (this.bindings[e.key] || [])
                                    .concat(this.bindings[e.which] || [])
                                    .filter((t) => m.match(e, t));
                                if (0 !== n.length) {
                                    var t = g.Ay.find(e.target, !0);
                                    if (!t || t.scroll === this.quill.scroll) {
                                        const r = this.quill.getSelection();
                                        if (
                                            null != r &&
                                            this.quill.hasFocus()
                                        ) {
                                            const [i, s] = this.quill.getLine(
                                                    r.index
                                                ),
                                                [o, l] = this.quill.getLeaf(
                                                    r.index
                                                ),
                                                [a, c] =
                                                    0 === r.length
                                                ...
                                                u =
                                                    o instanceof p.TextBlot
                                                        ? o.value().slice(0, l)
                                                        : "",
                                                h =
                                                    a instanceof p.TextBlot
                                                        ? a.value().slice(c)
                                                        : "",
                                                d = {
                    ...
                    handleBackspace(e, n) {
                        ...
                        if (!(0 === e.index || this.quill.getLength() <= 1)) {
                            ...
                            let t = new (c())().retain(e.index - r).delete(r);
                            if (0 === n.offset) {
                                const [n] = this.quill.getLine(e.index - 1);
                                if (
                                    n &&
                                    !(
                                    ...
                                    if (
                                        ((i = o.AttributeMap.diff(n, r) || {}),
                                        0 < Object.keys(i).length)
                                    ) {
                                        const n = new (c())()
                                            .retain(e.index + s.length() - 2)
                                            .retain(1, i);
                                        t = t.compose(n);
                                    }
                                }
                            }
                            this.quill.updateContents(t, g.Ay.sources.USER),
                                this.quill.focus();
                        }
                    }
                    handleDelete(e, n) {
                        ...
                        if (!(e.index >= this.quill.getLength() - r)) {
                            ...
                            let t = new (c())().retain(e.index).delete(r);
                            if (n.offset >= i.length() - 1) {
                                const [n] = this.quill.getLine(e.index + 1);
                                if (n) {
                                    const r = i.formats(),
                                        c = this.quill.getFormat(e.index, 1);
                                    (e = o.AttributeMap.diff(r, c) || {}),
                    ...
                    handleDeleteRange(t) {
                        d({ range: t, quill: this.quill }), this.quill.focus();
                    }
                    handleEnter(t, n) {
                        var e = Object.keys(n.format).reduce(
                                (t, e) => (
                                    this.quill.scroll.query(e, p.Scope.BLOCK) &&
                            ...
                            e = new (c())()
                                ...
                                .delete(t.length)
                                .insert("\n", e);
                        this.quill.updateContents(e, g.Ay.sources.USER),
                            this.quill.setSelection(
                                t.index + 1,
                                g.Ay.sources.SILENT
                            ),
                    ...
                    bindings: {
                        ...
                        "checklist enter": {
                            ...
                            handler(t) {
                                ...
                                this.quill.updateContents(i, g.Ay.sources.USER),
                                    this.quill.setSelection(
                                        t.index + 1,
                                        g.Ay.sources.SILENT
                                    ),
                        ...
                        "table enter": {
                            ...
                            format: ["table"],
                            handler(e) {
                                const n = this.quill.getModule("table");
                                if (n) {
                                    const [i, s, o, l] = n.getTable(e),
                                        a =
                                            ((r = o),
                                            null == (t = s).prev &&
                                            null == t.next
                        ...
                        "embed left": a("ArrowLeft", !1),
                        "embed left shift": a("ArrowLeft", !0),
                        "embed right": a("ArrowRight", !1),
                        "embed right shift": a("ArrowRight", !0),
                        "table down": h(!1),
                        "table up": h(!0),
                    },
                };
                                ...
                                l
                                    ? (t.insertAt(0, r),
                                      0 === e
                                          ? (s += r.length)
                                          : (o += r.length))
                                    : t.domNode.textContent.startsWith(r) &&
                                      (t.deleteAt(0, r.length),
                                      0 === e
                                          ? (s -= r.length)
                                          : (o -= r.length));
                            }),
                                this.quill.update(g.Ay.sources.USER),
                                this.quill.setSelection(
                                    s,
                                    o,
                                    g.Ay.sources.SILENT
                ...
                function a(r, i) {
                    return {
                        ...
                        shiftKey: i,
                        altKey: null,
                        ["ArrowLeft" === r ? "prefix" : "suffix"]: /^$/,
                        handler(t) {
                            let e = t["index"];
                            "ArrowRight" === r && (e += t.length + 1);
                            var [n] = this.quill.getLeaf(e);
                            return !(
                                n instanceof p.EmbedBlot &&
                                ("ArrowLeft" === r
                                    ? i
                                        ? this.quill.setSelection(
                                              t.index - 1,
                ...
                function d(t) {
                    ...
                    if (1 < r.length) {
                        ...
                        i = o.AttributeMap.diff(e, t) || {};
                    }
                    e.deleteText(n, g.Ay.sources.USER),
                        0 < Object.keys(i).length &&
                            e.formatLine(n.index, 1, i, g.Ay.sources.USER),
                        e.setSelection(n.index, g.Ay.sources.SILENT);
                }
                m.DEFAULTS = e;
            },
            8920: function (t) {
                ...
                function i(t, e, n, r, i) {
                    ...
                    (n = new s(n, r || t, i)), (r = f ? f + e : e);
                    return (
                        t._events[r]
                            ? t._events[r].fn
                                ? (t._events[r] = [t._events[r], n])
                                : t._events[r].push(n)
                            : ((t._events[r] = n), t._eventsCount++),
                        t
                    );
                }
                function a(t, e) {
                ...
                Object.create &&
                    ...
                    (e.prototype.eventNames = function () {
                        ...
                        for (e in (t = this._events))
                            r.call(t, e) && n.push(f ? e.slice(1) : e);
                    ...
                    (e.prototype.listeners = function (t) {
                        ...
                        if (e.fn) return [e.fn];
                        for (
                            var n = 0, r = e.length, i = new Array(r);
                            n < r;
                            n++
                        )
                            i[n] = e[n].fn;
                    ...
                    (e.prototype.emit = function (t, e, n, r, i, s) {
                        var o = f ? f + t : t;
                        ...
                        if (a.fn) {
                            switch (
                                (a.once &&
                                    this.removeListener(t, a.fn, void 0, !0),
                                c)
                            ) {
                                case 1:
                                ...
                                case 3:
                                    return a.fn.call(a.context, e, n), !0;
                                case 4:
                                    return a.fn.call(a.context, e, n, r), !0;
                                case 5:
                                    return a.fn.call(a.context, e, n, r, i), !0;
                                case 6:
                                    return (
                                        a.fn.call(a.context, e, n, r, i, s), !0
                                    );
                            }
                            ...
                            for (var u, h = a.length, d = 0; d < h; d++)
                                switch (
                                    (a[d].once &&
                                        this.removeListener(
                                            t,
                                    ...
                                    case 1:
                                        ...
                                        break;
                                    case 2:
                                        a[d].fn.call(a[d].context, e);
                                        break;
                                    case 3:
                                        a[d].fn.call(a[d].context, e, n);
                                        break;
                                    case 4:
                                        a[d].fn.call(a[d].context, e, n, r);
                                        break;
                                    default:
                                        if (!l)
                                            for (
                    ...
                    (e.prototype.removeListener = function (t, e, n, r) {
                        t = f ? f + t : t;
                        ...
                        if (i.fn)
                            ...
                            for (var s = 0, o = [], l = i.length; s < l; s++)
                                (i[s].fn !== e ||
                                    (r && !i[s].once) ||
                                    (n && i[s].context !== n)) &&
                                    o.push(i[s]);
                            o.length
                                ? (this._events[t] = 1 === o.length ? o[0] : o)
                                : a(this, t);
                        }
                        return this;
                    }),
            ...
            5090: function (t) {
                ...
                function U(t, e, v, n, r) {
                        ...
                        var i = (function (t, e) {
                            var n =
                                    "number" == typeof v
                                        ? { index: v, length: 0 }
                                        : v.oldRange,
                                r = "number" == typeof v ? null : v.newRange,
                                i = t.length,
                                s = e.length;
                            if (
                                0 === n.length &&
                                ...
                                if (null === c || c === o) {
                                    var u = o,
                                        f = ((h = e.slice(0, u)), e.slice(u));
                                    if (h === l) {
                                        var p = Math.min(i - u, s - u);
                                        if (
                                            (m = a.slice(a.length - p)) ===
                                            (y = f.slice(f.length - p))
                                        )
                                            return G(
                                                l,
                                                a.slice(0, a.length - p),
                                                f.slice(0, f.length - p),
                                                m
                                            );
                                    }
                                }
                            }
                            if (0 < n.length && r && 0 === r.length) {
                                var g = t.slice(0, n.index),
                                    m = t.slice(n.index + n.length);
                                if (!(s < (d = g.length) + (p = m.length))) {
                                    var b = e.slice(0, d),
                                        y = e.slice(s - p);
                                    if (g === b && m === y)
                                        return G(
                    ...
                    var i = P(t, e),
                        s = t.substring(0, i),
                        i = F((t = t.substring(i)), (e = e.substring(i))),
                        o = t.substring(t.length - i),
                        t = (function (t, e) {
                            if (!t) return [[B, e]];
                            if (!e) return [[I, t]];
                            ...
                            var s,
                                ...
                                i = (function (t, e) {
                                    ...
                                    var s,
                                        ...
                                        l,
                                        a,
                                        c = i(n, r, Math.ceil(n.length / 4)),
                                        r = i(n, r, Math.ceil(n.length / 2));
                                    return c || r
                                        ? ((n =
                                              !r ||
                                              (c && c[4].length > r[4].length)
                                                  ? c
                                                  : r),
                                          t.length > e.length
                                              ? ((s = n[0]),
                    ...
                    if (
                            ...
                            l[m][0] == M
                                ...
                                : (l[m][0] == B
                                  ...
                                  g &&
                                      ...
                                      g.length <= Math.max(A, x) &&
                                      (l.splice(f[p - 1], 0, [I, g]),
                                      (l[f[p - 1] + 1][0] = B),
                                      p--,
                                      (m = 0 < --p ? f[p - 1] : -1),
                                      (x = A = y = b = 0),
                        ...
                        for (var w = 1; w < N.length - 1; ) {
                            if (N[w - 1][0] == M && N[w + 1][0] == M) {
                                var q,
                                    ...
                                    S = F(k, _);
                                S &&
                                    ((q = _.substring(_.length - S)),
                                    (k = k.substring(0, k.length - S)),
                                    (_ = q + _.substring(0, _.length - S)),
                                    (L = q + L));
                                for (
                                    var O = k,
                                        T = _,
                                        j = L,
                                        C = E(k, _) + E(_, L);
                                    _.charAt(0) === L.charAt(0);

                                ) {
                                    (k += _.charAt(0)),
                                        (_ = _.substring(1) + L.charAt(0)),
                                        (L = L.substring(1));
                                    var R = E(k, _) + E(_, L);
                                    C <= R &&
                                        ((C = R), (O = k), (T = _), (j = L));
                        ...
                        for (m = 1; m < l.length; )
                            l[m - 1][0] == I &&
                                l[m][0] == B &&
                                ((u = z((a = l[m - 1][1]), (c = l[m][1]))),
                                (h = z(c, a)) <= u
                                    ? (u >= a.length / 2 ||
                                          u >= c.length / 2) &&
                                      (l.splice(m, 0, [M, c.substring(0, u)]),
                                      (l[m - 1][1] = a.substring(
                                          0,
                                          a.length - u
                                      )),
                                      (l[m + 1][1] = c.substring(u)),
                                      m++)
                                    : (h >= a.length / 2 ||
                                          h >= c.length / 2) &&
                                      (l.splice(m, 0, [M, a.substring(0, h)]),
                                      (l[m - 1][0] = B),
                                      (l[m - 1][1] = c.substring(
                                          0,
                                          c.length - h
                ...
                function F(t, e) {
                    ...
                    for (
                        ...
                        e.substring(e.length - i, e.length - s)
                            ...
                            : (r = i),
                            (i = Math.floor((r - n) / 2 + n));
                    return l(t.charCodeAt(t.length - i)) && i--, i;
                }
                var H = /[^a-zA-Z0-9]/,
                    V = /\s/,
                    $ = /[\r\n]/,
                ...
                function h(t) {
                    return l(t.charCodeAt(0));
                }
                function d(t) {
                    return o(t.charCodeAt(t.length - 1));
                }
                function G(t, e, n, r) {
                    if (d(t) || h(r)) return null;
                    for (
                        var i = [
                                [M, t],
                                [I, e],
                        ...
                        0 < i[o][1].length && s.push(i[o]);
                    return s;
                }
                function e(t, e, n, r) {
                    return U(t, e, n, r, !0);
                }
                (e.INSERT = B), (e.DELETE = I), (e.EQUAL = M), (t.exports = e);
            },
            9629: function (t, e, n) {
                t = n.nmd(t);
                ...
                var i = Array.prototype,
                    ...
                    o = n.Symbol,
                    pt = n.Uint8Array,
                    gt = s(Object.getPrototypeOf, Object),
                    mt = Object.create,
                    bt = l.propertyIsEnumerable,
                    yt = i.splice,
                    e = Object.getOwnPropertySymbols,
                    i = a ? a.isBuffer : void 0,
                    vt = s(Object.keys, Object),
                    a = v(n, "DataView"),
                    u = v(n, "Map"),
                    h = v(n, "Promise"),
                    d = v(n, "Set"),
                ...
                function kt(t, e, n) {
                    var r = t[e];
                    (T.call(t, e) && Ot(r, n) && (void 0 !== n || e in t)) ||
                        (t[e] = n);
                }
                function b(t, e) {
                ...
                function C(a, t, e, n, r, i, s) {
                    var o;
                    if (void 0 !== (o = n ? (i ? n(a, r, i, s) : n(a)) : o))
                        return o;
                    if (!M(a)) return a;
                    var l,
                        r = B(a);
                ...
                (p.prototype.clear = function () {
                    ...
                    (p.prototype.has = function (t) {
                        var e = this.__data__;
                        return f ? void 0 !== e[t] : T.call(e, t);
                    }),
                    (p.prototype.set = function (t, e) {
                        return (
                            (this.__data__[t] = f && void 0 === e ? x : e), this
                        );
                    }),
                    ...
                    (g.prototype.delete = function (t) {
                        ...
                        return !(
                            t < 0 ||
                            (t == e.length - 1 ? e.pop() : yt.call(e, t, 1), 0)
                        );
                    }),
            ...
            4162: function (t, e, n) {
                ...
                function Nt(t, e, n, r, i, s) {
                    var o = n & y,
                        l = t.length,
                        a = e.length;
                    if (l != a && !(o && l < a)) return !1;
                    a = s.get(t);
                    if (a && s.get(e)) return a == e;
                    var c = -1,
                        u = !0,
                        h = n & B ? new k() : void 0;
                ...
                function Et(t) {
                    ...
                    if (R(t)) return n;
                    for (
                        var r = n, i = e(t), s = -1, o = i.length, l = r.length;
                        ++s < o;
                ...
                (E.prototype.clear = function () {
                    ...
                    (E.prototype.has = function (t) {
                        var e = this.__data__;
                        return N ? void 0 !== e[t] : v.call(e, t);
                    }),
                    ...
                    (w.prototype.delete = function (t) {
                        ...
                        return !(
                            t < 0 ||
                            (t == e.length - 1 ? e.pop() : ut.call(e, t, 1),
                            --this.size,
                            0)
                        );
                    }),
                ...
                function Lt(t) {
                    if (Ot(t))
                        return (t = S(t)), t == F || t == H || t == U || t == W;
                }
                function St(t) {
                    return (
                        "number" == typeof t && -1 < t && t % 1 == 0 && t <= M
                    );
                }
                function Ot(t) {
                    var e = typeof t;
                ...
                var Tt,
                    jt = n
                        ...
                        : function (t) {
                              return I(t) && St(t.length) && !!s[S(t)];
                          };
                function Ct(t) {
                    return (
                        null != t && St(t.length) && !Lt(t)
                            ? function (t) {
                                  var e,
                                      n,
                                      r,
            ...
            1270: function (t, e, n) {
                ...
                const i = n(9629),
                    s = n(4162);
                var r;
                ((n = r = r || {}).compose = function (t = {}, e = {}, n = !1) {
                    "object" != typeof t && (t = {}),
                        "object" != typeof e && (e = {});
                    let r = i(e);
                    n ||
                        (r = Object.keys(r).reduce(
                            (t, e) => (null != r[e] && (t[e] = r[e]), t),
                            {}
                        ));
                    for (const n in t)
                        void 0 !== t[n] && void 0 === e[n] && (r[n] = t[n]);
                    ...
                    (n.transform = function (n, r, t = !1) {
                        if ("object" != typeof n) return r;
                        if ("object" == typeof r) {
                            if (!t) return r;
                            t = Object.keys(r).reduce(
                                (t, e) => (void 0 === n[e] && (t[e] = r[e]), t),
                                {}
                            );
                            return 0 < Object.keys(t).length ? t : void 0;
                        }
            ...
            5232: function (t, e, n) {
                ...
                const l = n(5090),
                    ...
                    a = n(4162),
                    u = n(1270),
                    h = ((e.AttributeMap = u.default), n(4123)),
                    d = ((e.Op = h.default), n(7033)),
                    c = ((e.OpIterator = d.default), String.fromCharCode(0)),
                    f = (t, e) => {
                ...
                class p {
                    ...
                    push(t) {
                        ...
                        if (((t = r(t)), "object" == typeof n)) {
                            ...
                            if (
                                "number" == typeof n.delete &&
                                null != t.insert &&
                                (--e, "object" != typeof (n = this.ops[e - 1]))
                            )
                                return this.ops.unshift(t), this;
                            if (a(t.attributes, n.attributes)) {
                                if (
                    ...
                    length() {
                        return this.reduce(
                            (t, e) => t + h.default.length(e),
                            0
                        );
                    }
                    slice(e = 0, n = 1 / 0) {
                        const r = [],
                            i = new d.default(this.ops);
                        let s = 0;
                        for (; s < n && i.hasNext(); ) {
                            let t;
                            s < e
                                ? (t = i.next(e - s))
                                : ((t = i.next(n - s)), r.push(t)),
                                (s += h.default.length(t));
                        }
                        return new p(r);
                    }
                    compose(t) {
                        const e = new d.default(this.ops),
                            n = new d.default(t.ops),
                            r = [],
                            i = n.peek();
                        if (
                            null != i &&
                            ...
                            0 < i.retain - t && n.next(i.retain - t);
                        }
                        const s = new p(r);
                            ...
                            if ("insert" === n.peekType()) s.push(n.next());
                                ...
                                if (i.retain) {
                                    ...
                                    if ("number" == typeof r.retain)
                                        ...
                                        const t =
                                                null == r.retain
                                                    ? "insert"
                                                    : "retain",
                                            [e, n, a] = f(r[t], i.retain),
                                            u = p.getHandler(e);
                                        d[t] = {
                                            [e]: u.compose(n, a, "retain" == t),
                                        };
                                    }
                                    var o = u.default.compose(
                                        r.attributes,
                                        i.attributes,
                                    ...
                                    if (
                                        ...
                                        s.push(d),
                                        !n.hasNext() &&
                                            a(s.ops[s.ops.length - 1], d))
                                    ) {
                                        const t = new p(e.rest());
                                        return s.concat(t).chop();
                                    }
                                } else
                    ...
                    diff(n, t) {
                        ...
                        const e = [this, n].map((e) =>
                            ...
                            i = new p(),
                            r = l(e[0], e[1], t, !0),
                            s = new d.default(this.ops),
                            o = new d.default(n.ops);
                        return (
                            r.forEach((e) => {
                                let n = e[1].length;
                                for (; 0 < n; ) {
                                    ...
                                    switch (e[0]) {
                                        case l.INSERT:
                                            (t = Math.min(o.peekLength(), n)),
                                                i.push(o.next(t));
                                            break;
                                        case l.DELETE:
                                            (t = Math.min(n, s.peekLength())),
                                                s.next(t),
                                                i.delete(t);
                                            break;
                                        case l.EQUAL:
                    ...
                    eachLine(t, e = "\n") {
                        const n = new d.default(this.ops);
                        let r = new p(),
                            i = 0;
                        for (; n.hasNext(); ) {
                            if ("insert" !== n.peekType()) return;
                            const s = n.peek(),
                                o = h.default.length(s) - n.peekLength(),
                                d =
                                    "string" == typeof s.insert
                                        ? s.insert.indexOf(e, o) - o
                                        : -1;
                            if (d < 0) r.push(n.next());
                            else if (0 < d) r.push(n.next(d));
                            else {
                    ...
                    invert(a) {
                        ...
                        return (
                            this.reduce((t, e) => {
                                if (e.insert) c.delete(h.default.length(e));
                                else {
                                    if (
                                        "number" == typeof e.retain &&
                                        null == e.attributes
                                    )
                                        return c.retain(e.retain), t + e.retain;
                                    var n;
                                    if (e.delete || "number" == typeof e.retain)
                                        return (
                                            (n = e.delete || e.retain),
                                            a.slice(t, t + n).forEach((t) => {
                                                e.delete
                                                    ? c.push(t)
                                                    : e.retain &&
                                                      e.attributes &&
                                    ...
                                    if (
                                        ...
                                        const r = a.slice(t, t + 1),
                                            i = new d.default(r.ops).next(),
                                            [h, s, o] = f(e.retain, i.insert),
                                            l = p.getHandler(h);
                                        return (
                                            c.retain(
                                                { [h]: l.invert(s, o) },
                    ...
                    transform(e, n = !1) {
                        if (((n = !!n), "number" == typeof e))
                            return this.transformPosition(e, n);
                        const r = e,
                            i = new d.default(this.ops),
                            s = new d.default(r.ops),
                            o = new p();
                        for (; i.hasNext() || s.hasNext(); )
                            if (
                                ...
                                if ("insert" === s.peekType()) o.push(s.next());
                                else {
                                    const e = Math.min(
                                            i.peekLength(),
                                            s.peekLength()
                                    ...
                                    if (h.delete) o.push(h);
                                        ...
                                        if (
                                            ...
                                            if (e === Object.keys(s)[0]) {
                                                const r = p.getHandler(e);
                                                r &&
                                                    (t = {
                                                        [e]: r.transform(
                                                            i[e],
                            ...
                            else o.retain(h.default.length(i.next()));
                        return o.chop();
                    }
                ...
                (p.Op = h.default),
                    (p.OpIterator = d.default),
                    (p.AttributeMap = u.default),
                    (p.handlers = {}),
                    (e.default = p),
                    (t.exports = p),
                    (t.exports.default = p);
            ...
            7033: function (t, e, n) {
                ...
                e.default = class {
                    ...
                    peekLength() {
                        return this.ops[this.index]
                            ? i.default.length(this.ops[this.index]) -
                                  this.offset
                            : 1 / 0;
                    }
                    peekType() {
            ...
            8820: function (t, e, n) {
                ...
                (o.prototype.clear = function () {
                    ...
                    (o.prototype.delete = function (t) {
                        ...
                        return !(
                            t < 0 ||
                            (t == e.length - 1 ? e.pop() : s.call(e, t, 1),
                            --this.size,
                            0)
                        );
                    }),
            ...
            3812: function (t, e, n) {
                ...
                var n = n(5507),
                    ...
                    i =
                        ...
                        !module.nodeType &&
                        module,
                    i = i && i.exports === r ? n.A.Buffer : void 0,
                    s = i ? i.allocUnsafe : void 0;
                e.A = function (t, e) {
                    if (e) return t.slice();
                    (e = t.length), (e = s ? s(e) : new t.constructor(e));
                    return t.copy(e), e;
                };
            },
            1827: function (t, e, n) {
            ...
            8769: function (t, e, n) {
                "use strict";
                n = (0, n(2217).A)(Object.getPrototypeOf, Object);
                e.A = n;
            },
            9844: function (t, e, n) {
                "use strict";
            ...
            3707: function (d, t, e) {
                ...
                function x(n, r, i, t, e, s) {
                    var o,
                        ...
                        u = 2 & r,
                        h = 4 & r;
                    if (void 0 !== (o = i ? (e ? i(n, t, e, s) : i(n)) : o))
                        return o;
                    if (!(0, P.A)(n)) return n;
                    if ((t = (0, M.A)(n))) {
                        if (
                            ((d = (f = n).length),
                            (a = new f.constructor(d)),
                            d &&
                                "string" == typeof f[0] &&
                                R.call(f, "index") &&
                                ((a.index = f.index), (a.input = f.input)),
                            (o = a),
                            !c)
                        )
                            return (0, L.A)(n, o);
                        ...
                        var d = (0, C.A)(n),
                            f = d == F || "[object GeneratorFunction]" == d;
                        if ((0, U.A)(n)) return (0, _.A)(n, c);
                        if (d == H || d == z || (f && !e)) {
                            if (((o = u || f ? {} : (0, B.A)(n)), !c))
                                return u
                                    ? ((a = n),
            ...
            8412: function (t, e, n) {
                ...
                function r(t) {
                    return (0, s.A)(t) && "[object Arguments]" == (0, i.A)(t);
                }
                var i = n(2159),
                    s = n(7948),
                    e = Object.prototype,
                    o = e.hasOwnProperty,
                    l = e.propertyIsEnumerable,
                    a = r(
                        (function () {
                            return arguments;
                        })()
            ...
            776: function (t, e, n) {
                ...
                var e = n(5507),
                    ...
                    r =
                        ...
                        !module.nodeType &&
                        module,
                    r = r && r.exports === n ? e.A.Buffer : void 0,
                    i =
                        (r ? r.isBuffer : void 0) ||
                        function () {
                            return !1;
            ...
            5123: function (t, e, n) {
                ...
                var m = i,
                    ...
                    g = n(7218),
                    b = n(8138),
                    e = e.A ? e.A.prototype : void 0,
                    y = e ? e.valueOf : void 0,
                    v = n(2816),
                    ...
                    o = function (t, e, n, r, i, s) {
                        ...
                        if (!(1 & n)) {
                            (o = c && L.call(t, "__wrapped__")),
                                (c = u && L.call(e, "__wrapped__"));
                            if (o || c)
                                return i(
                                    o ? t.value() : t,
                                    c ? e.value() : e,
                        ...
                        return (
                            ...
                            (function (t, e, n, r, i, s) {
                                var o = 1 & n,
                                    l = (0, v.A)(t),
                                    a = l.length;
                                if (a != (0, v.A)(e).length && !o) return !1;
                                for (var c = a; c--; ) {
                                    var u = l[c];
                                    if (!(o ? u in e : A.call(e, u))) return !1;
                                }
                                var h = s.get(t),
                                    d = s.get(e);
                    ...
                    r = function (t) {
                        ...
                        if ((0, a.A)(e)) {
                            var n,
                                ...
                                i = [];
                            for (n in e)
                                ("constructor" != n || (!r && u.call(e, n))) &&
                                    i.push(n);
                            return i;
                        }
                        var s = [];
                        if (null != e) for (var o in Object(e)) s.push(o);
                        return s;
                    };
            },
            8347: function (B, t, e) {
                ...
                var r,
                    ...
                    p = e(8138),
                    g = function (t, e, n) {
                        ((void 0 === n || (0, p.A)(t[e], n)) &&
                            (void 0 !== n || e in t)) ||
                            (0, f.A)(t, e, n);
                    },
                    m = function (t, e, n) {
                        for (
                            var r = -1, i = Object(t), s = n(t), o = s.length;
                            o--;
                                  ...
                                  l || a || c
                                      ...
                                      ? (0, x.A)((d = u))
                                          ...
                                          : ((0, _.A)(u) && !(0, k.A)(u)) ||
                                            (d = (0, A.A)(h))
                                      : (e = !1)),
                              e && (o.set(h, d), i(d, h, r, s, o), o.delete(h)),
                              g(t, n, d));
                    },
                    R = Math.max,
                    I = e(7889),
                            ...
                            function () {
                                ...
                                switch (l.length) {
                                    ...
                                    case 1:
                                        return s.call(o, l[0]);
                                    case 2:
                                        return s.call(o, l[0], l[1]);
                                    case 3:
                                        return s.call(o, l[0], l[1], l[2]);
                                }
                                return s.apply(o, l);
                            }),
                            O + ""
            ...
            6003: function (l, t, e) {
                ...
                t = class l {
                    ...
                    create(t, e, n) {
                        var r = this.query(e);
                        if (null == r)
                            throw new a(`Unable to create ${e} blot`);
                        const i = r,
                            s =
                                e instanceof Node ||
                    ...
                    register(...t) {
                        return t.map((e) => {
                            var t = "blotName" in e,
                                n = "attrName" in e;
                            if (!t && !n) throw new a("Invalid definition");
                            if (t && "abstract" === e.blotName)
                                throw new a("Cannot register abstract class");
                            var r = t ? e.blotName : n ? e.attrName : void 0;
                            return (
                                (this.types[r] = e),
                                n
                                    ...
                                    : t &&
                                      (e.className &&
                                          (this.classes[e.className] = e),
                                      e.tagName &&
                                          (Array.isArray(e.tagName)
                                              ? (e.tagName = e.tagName.map(
                                                    (t) => t.toUpperCase()
                                                ))
                                              : (e.tagName =
                ...
                const c = class extends i {
                    ...
                    value(t) {
                        var e = (n(t, this.keyName)[0] || "").slice(
                ...
                const u = class extends i {
                    ...
                    h = class {
                        ...
                        build() {
                            this.attributes = {};
                            const e = o.find(this.domNode);
                            if (null != e) {
                                const t = i.keys(this.domNode),
                                    n = c.keys(this.domNode),
                                    r = u.keys(this.domNode);
                                t.concat(n)
                                    .concat(r)
                                    .forEach((t) => {
                                        t = e.scroll.query(t, s.ATTRIBUTE);
                                        t instanceof i &&
                                            (this.attributes[t.attrName] = t);
                                    });
                            }
                        ...
                        copy(n) {
                            Object.keys(this.attributes).forEach((t) => {
                                var e = this.attributes[t].value(this.domNode);
                                n.format(t, e);
                            });
                        }
                        move(t) {
                    ...
                    d = class {
                        ...
                        static create(t) {
                            if (null == this.tagName)
                                throw new a("Blot definition missing tagName");
                            let e, n;
                            return (
                        ...
                        formatAt(t, e, n, r) {
                            const i = this.isolate(t, e);
                            if (null != this.scroll.query(n, s.BLOT) && r)
                                i.wrap(n, r);
                            else if (
                                null != this.scroll.query(n, s.ATTRIBUTE)
                            ) {
                                const t = this.scroll.create(
                                    this.statics.scope
                                );
                                i.wrap(t), t.format(n, r);
                            }
                        }
                        insertAt(t, e, n) {
                            (e =
                                ...
                                (n = this.split(t));
                            this.parent.insertBefore(e, n || void 0);
                        }
                        isolate(t, e) {
                ...
                class p {
                    ...
                    forEachAt(n, r, i) {
                        if (!(r <= 0)) {
                            ...
                            for (; e && t < n + r; ) {
                                const s = e.length();
                                n > t
                                    ? i(e, n - t, Math.min(r, t + s - n))
                                    : i(e, 0, Math.min(s, n + r - t)),
                                    (t += s),
                                    (e = l());
                            }
                        }
                    ...
                    map(n) {
                        return this.reduce((t, e) => (t.push(n(e)), t), []);
                    }
                    reduce(t, e) {
                        const n = this.iterator();
                        let r = n();
                ...
                t = class l extends e {
                    ...
                    attachUI(t) {
                        null != this.uiNode && this.uiNode.remove(),
                            (this.uiNode = t),
                            l.uiClass && this.uiNode.classList.add(l.uiClass),
                    ...
                    descendants(r, t = 0, e = Number.MAX_VALUE) {
                        let i = [],
                            s = e;
                        return (
                            this.children.forEachAt(t, e, (t, e, n) => {
                                ((null == r.blotName && r(t)) ||
                                    (null != r.blotName && t instanceof r)) &&
                                    i.push(t),
                                    t instanceof l &&
                                        (i = i.concat(t.descendants(r, e, s))),
                                    (s -= n);
                            }),
                            i
                        );
                    ...
                    replaceWith(t, e) {
                        e = "string" == typeof t ? this.scroll.create(t, e) : t;
                        return (
                            e instanceof l && this.moveChildren(e),
                            super.replaceWith(e)
                        );
                    }
                    split(t, r = !1) {
                ...
                const m = t,
                    b = class l extends m {
                        ...
                        static formats(t, e) {
                            e = e.query(l.blotName);
                            if (null == e || t.tagName !== e.tagName)
                                return (
                        ...
                        constructor(t, e) {
                            super(t, e),
                                (this.attributes = new h(this.domNode));
                        }
                        format(t, e) {
                            if (t !== this.statics.blotName || e) {
                                const l = this.scroll.query(t, s.INLINE);
                                null != l &&
                                    (l instanceof i
                                        ? this.attributes.attribute(l, e)
                                        : !e ||
                        ...
                        formatAt(t, e, n, r) {
                            null != this.formats()[n] ||
                            this.scroll.query(n, s.ATTRIBUTE)
                        ...
                        replaceWith(t, e) {
                            t = super.replaceWith(t, e);
                            return this.attributes.copy(t), t;
                        }
                        update(t, e) {
                            super.update(t, e),
                                t.some(
                        ...
                        wrap(t, e) {
                            t = super.wrap(t, e);
                            return t instanceof l && this.attributes.move(t), t;
                        }
                    },
                    y =
                        ((b.allowedChildren = [b, f]),
                        (b.blotName = "inline"),
                        (b.scope = s.INLINE_BLOT),
                        (b.tagName = "SPAN"),
                        b),
                    v = class l extends m {
                        static create(t) {
                        ...
                        format(t, e) {
                            var n = this.scroll.query(t, s.BLOCK);
                            null != n &&
                                (n instanceof i
                        ...
                        formatAt(t, e, n, r) {
                            null != this.scroll.query(n, s.BLOCK)
                                ? this.format(n, r)
                                : super.formatAt(t, e, n, r);
                        }
                        insertAt(t, e, n) {
                            if (
                                null == n ||
                                null != this.scroll.query(e, s.INLINE)
                            )
                    ...
                    A =
                        ((v.blotName = "block"),
                        (v.scope = s.BLOCK_BLOT),
                        (v.tagName = "P"),
                        (v.allowedChildren = [y, v, f]),
                        v),
                    x = class extends m {
                        checkMerge() {
                            return (
                    ...
                    N =
                        ((x.blotName = "container"),
                        (x.scope = s.BLOCK_BLOT),
                        x),
                    E = class extends f {
                        static formats(t, e) {}
                        format(t, e) {
                    ...
                    q = class extends m {
                        constructor(t, e) {
                            super(null, e),
                                (this.registry = t),
                                (this.scroll = this).build(),
                                (this.observer = new MutationObserver((t) => {
                                    this.update(t);
                                })),
                                this.observer.observe(this.domNode, w),
                                this.attach();
                        }
                        create(t, e) {
                        ...
                        find(t, e = !1) {
                            t = this.registry.find(t, e);
                            return t
                                ? t.scroll === this
                                    ? t
                                    : e
                                    ? this.find(t.scroll.domNode.parentNode, !0)
                                    : null
                                : null;
                        }
                        query(t, e = s.ANY) {
                        ...
                        update(t, e = {}) {
                            ...
                            t
                                ...
                                (e.mutationsMap = n).has(this.domNode) &&
                    ...
                    k =
                        ((q.blotName = "scroll"),
                        (q.defaultChild = A),
                        (q.allowedChildren = [A, N]),
                        (q.scope = s.BLOCK_BLOT),
                        (q.tagName = "DIV"),
                        q),
                    _ = class l extends f {
                        static create(t) {
                        ...
                        split(t, e = !1) {
                            ...
                            e = this.scroll.create(this.domNode.splitText(t));
                            return (
                                this.parent.insertBefore(
                                    e,
                                    this.next || void 0
                    ...
                    L = ((_.blotName = "text"), (_.scope = s.INLINE_BLOT), _);
            },
        }),
        (r = {}),
        (kt.n = function (t) {
        ...
        (function () {
            ...
            var t = kt(3729),
                ...
                n = kt(7912),
                i = kt(6003);
            class B extends i.ClassAttributor {
                add(t, e) {
                    let n = 0;
                    var r;
                    return (
                ...
                canAdd(t, e) {
                    return (
                        super.canAdd(t, e) || super.canAdd(t, parseInt(e, 10))
                    );
                }
                value(t) {
            ...
            var M = new B("indent", "ql-indent", {
                    scope: i.Scope.BLOCK,
                    whitelist: [1, 2, 3, 4, 5, 6, 7, 8],
                }),
                s = kt(9698);
            class U extends s.Ay {
                static blotName = "blockquote";
                static tagName = "blockquote";
            }
            var D = U;
            class P extends s.Ay {
            ...
            class a extends s.Ay {
                ...
                constructor(n, r) {
                    super(n, r);
                    const t = r.ownerDocument.createElement("span"),
                        e = (t) => {
                            var e;
                            n.isEnabled() &&
                                ("checked" === (e = this.statics.formats(r, n))
            ...
            function H(t, e) {
                ...
                n.href = t;
                t = n.href.slice(0, n.href.indexOf(":"));
            ...
            var G = Z;
            const X = ["alt", "height", "width"];
            class Q extends i.EmbedBlot {
                ...
                static formats(n) {
                    return X.reduce(
                        (t, e) => (
                            n.hasAttribute(e) && (t[e] = n.getAttribute(e)), t
                        ),
                        {}
                    );
                }
                ...
                static sanitize(t) {
                    return H(t, ["http", "https", "data"]) ? t : "//:0";
                }
                static value(t) {
            ...
            var et = tt,
                ...
                x = kt(5508),
                nt = kt(584);
            const N = new i.ClassAttributor("code-token", "hljs", {
                scope: i.Scope.INLINE,
            });
            class E extends f.A {
                static formats(t, e) {
                    for (; null != t && t !== e.domNode; ) {
                        if (t.classList && t.classList.contains(m.Ay.className))
                            return super.formats(t, e);
                        t = t.parentNode;
                    }
                }
                constructor(t, e, n) {
                    super(t, e, n), N.add(this.domNode, n);
                }
                format(t, e) {
                    t !== E.blotName
                        ? super.format(t, e)
                        : e
                        ? N.add(this.domNode, e)
                        : (N.remove(this.domNode),
                ...
                optimize() {
                    super.optimize(...arguments),
                        N.value(this.domNode) || this.unwrap();
                }
            }
            (E.blotName = "code-token"), (E.className = "ql-token");
            class w extends m.Ay {
                static create(t) {
                    const e = super.create(t);
                    return (
                        "string" == typeof t &&
                ...
                replaceWith(t, e) {
                    return (
                        this.formatAt(0, this.length(), E.blotName, !1),
                        super.replaceWith(t, e)
                    );
                }
            }
            class q extends m.EJ {
                attach() {
                    super.attach(),
                        (this.forceNext = !1),
                ...
                highlight(t) {
                    ...
                    if (null != this.children.head) {
                        const n =
                                ...
                                `
`,
                            r = w.formats(this.children.head.domNode);
...
${(0, x.X)(this.code(t, e))}
                ...
                optimize(t) {
                    if (
                        ...
                        const t = w.formats(this.children.head.domNode);
                        t !== this.uiNode.value && (this.uiNode.value = t);
                    }
                }
            }
            (q.allowedChildren = [w]),
                (w.requiredContainer = q),
                (w.allowedChildren = [E, A.A, x.A, v.A]);
            class rt extends b.A {
                ...
                initListener() {
                    this.quill.on(l.Ay.events.SCROLL_BLOT_MOUNT, (t) => {
                        if (t instanceof q) {
                            const r =
                            ...
                            this.options.languages.forEach((t) => {
                                var { key: t, label: e } = t;
                                const n =
                                    r.ownerDocument.createElement("option");
                                (n.textContent = e),
                                    n.setAttribute("value", t),
                                    r.appendChild(n);
                            }),
                                r.addEventListener("change", () => {
                                    t.format(w.blotName, r.value),
                ...
                initTimer() {
                    let t = null;
                    this.quill.on(l.Ay.events.SCROLL_OPTIMIZE, () => {
                        t && clearTimeout(t),
                            (t = setTimeout(() => {
                ...
                highlight() {
                    ...
                    this.quill.selection.composing ||
                        (this.quill.update(l.Ay.sources.USER),
                        (n = this.quill.getSelection()),
                        (null == t
                            ? this.quill.scroll.descendants(q)
                            : [t]
                        ).forEach((t) => {
                            t.highlight(this.highlightBlot, e);
                        }),
                        this.quill.update(l.Ay.sources.SILENT),
                        null != n &&
                            this.quill.setSelection(n, l.Ay.sources.SILENT));
                }
                highlightBlot(t) {
                    let r =
                        1 < arguments.length && void 0 !== arguments[1]
                            ? arguments[1]
                            : "plain";
                    if ("plain" === (r = this.languages[r] ? r : "plain"))
                        return (0, x.X)(t)
                            .split("\n")
                            .reduce(
                                (t, e, n) => (
                    ...
                    return (
                        e.classList.add(m.Ay.className),
                        (e.innerHTML = ((t, e, n) => {
            ...
            class S extends r.A {
                    ...
                    t.forEach((n) => {
                        new Array(e - n.children.length).fill(0).forEach(() => {
                            ...
                            null != n.children.head &&
                                (t = k.formats(n.children.head.domNode));
                            const e = this.scroll.create(k.blotName, t);
                            n.appendChild(e), e.optimize();
                        });
                    });
                }
                cells(e) {
                ...
                deleteColumn(n) {
                    const [t] = this.descendant(L);
                    null != t &&
                        null != t.children.head &&
                        t.children.forEach((t) => {
                            const e = t.children.at(n);
                            null != e && e.remove();
                        });
                }
                insertColumn(r) {
                    ...
                    null != t &&
                        null != t.children.head &&
                        t.children.forEach((t) => {
                            var e = t.children.at(r),
                                n = k.formats(t.children.head.domNode),
                                n = this.scroll.create(k.blotName, n);
                            t.insertBefore(n, e);
                        });
                }
                insertRow(t) {
                    const [e] = this.descendant(L);
                    if (null != e && null != e.children.head) {
                        const n = O(),
                            r = this.scroll.create(_.blotName);
                        e.children.head.children.forEach(() => {
                            var t = this.scroll.create(k.blotName, n);
                            r.appendChild(t);
                        });
                        t = e.children.at(t);
                        e.insertBefore(r, t);
            ...
            (S.allowedChildren = [L]),
                (L.requiredContainer = S),
                (L.allowedChildren = [_]),
                (_.requiredContainer = L),
                (_.allowedChildren = [k]),
                (k.requiredContainer = _);
            class it extends b.A {
                static register() {
                    l.Ay.register(k),
                        l.Ay.register(_),
                        l.Ay.register(L),
                ...
                balanceTables() {
                    this.quill.scroll.descendants(S).forEach((t) => {
                        t.balanceCells();
                    });
                }
                deleteColumn() {
                ...
                deleteRow() {
                    ...
                    null != t &&
                        (t.remove(), this.quill.update(l.Ay.sources.USER));
                }
                deleteTable() {
                    const [t] = this.getTable();
                    var e;
                    null != t &&
                        ...
                        t.remove(),
                        this.quill.update(l.Ay.sources.USER),
                        this.quill.setSelection(e, l.Ay.sources.SILENT));
                }
                getTable() {
                    var t =
                        0 < arguments.length && void 0 !== arguments[0]
                    ...
                    var [t, e] = this.quill.getLine(t.index);
                    if (null == t || t.statics.blotName !== k.blotName)
                        return [null, null, null, -1];
                    var n = t.parent;
                    return [n.parent.parent, n, t, e];
                }
                insertColumn(e) {
                    var n = this.quill.getSelection();
                    if (n) {
                        const [i, s, o] = this.getTable(n);
                        if (null != o) {
                            var r = o.cellOffset();
                            i.insertColumn(r + e),
                                this.quill.update(l.Ay.sources.USER);
                ...
                insertTable(t, n) {
                    ...
                    null != e &&
                        ((t = new Array(t).fill(0).reduce((t) => {
                            var e = new Array(n).fill("\n").join("");
                            return t.insert(e, { table: O() });
                        }, new (y())().retain(e.index))),
                        this.quill.updateContents(t, l.Ay.sources.USER),
                        this.quill.setSelection(e.index, l.Ay.sources.SILENT),
                        this.balanceTables());
                }
                listenBalanceCells() {
                    this.quill.on(l.Ay.events.SCROLL_OPTIMIZE, (t) => {
                        t.some(
                            (t) =>
            ...
            f = it;
            const st = (0, kt(6078).A)("quill:toolbar");
            class ot extends b.A {
                constructor(t, e) {
                    if ((super(t, e), Array.isArray(this.options.container))) {
                        ...
                        e.setAttribute("role", "toolbar"),
                            ...
                            (n = Array.isArray(n[0]) ? n : [n]).forEach((t) => {
                    ...
                    this.container instanceof HTMLElement
                        ? (this.container.classList.add("ql-toolbar"),
                          ...
                          this.quill.on(l.Ay.events.EDITOR_CHANGE, () => {
                ...
                attach(n) {
                    let r = Array.from(n.classList).find(
                        (t) => 0 === t.indexOf("ql-")
                    );
                    var t;
                    r &&
                        ...
                        null == this.handlers[r] &&
                        null == this.quill.scroll.query(r)
                            ? st.warn(
                            ...
                            : ((t =
                                  "SELECT" === n.tagName ? "change" : "click"),
                              n.addEventListener(t, (t) => {
                                  let e;
                                  if ("SELECT" === n.tagName) {
                                      if (n.selectedIndex < 0) return;
                                      ...
                                      (e =
                                          !n.classList.contains("ql-active") &&
                                          (n.value ||
                                  ...
                                  if (null != this.handlers[r])
                                      this.handlers[r].call(this, e);
                                  else if (
                                      this.quill.scroll.query(r)
                                          .prototype instanceof i.EmbedBlot
                                  ) {
                                      if (!(e = prompt("Enter " + r))) return;
                                      this.quill.updateContents(
                                          new (y())()
                                              .retain(t.index)
                                              .delete(t.length)
                              ...
                              this.controls.push([r, n])));
                }
                update(i) {
                    const s = null == i ? {} : this.quill.getFormat(i);
                    this.controls.forEach((t) => {
                        ...
                        if ("SELECT" === r.tagName) {
                            ...
                            if (null == i) e = null;
                                ...
                                e = r.querySelector("option[selected]");
                            else if (!Array.isArray(s[n])) {
                                let t = s[n];
                                "string" == typeof t &&
                                    (t = t.replace(/"/g, '\\"')),
                                    (e = r.querySelector(
                    ...
                    handlers: {
                        ...
                        link(t) {
                            !0 === t && (t = prompt("Enter link URL:")),
                                this.quill.format("link", t, l.Ay.sources.USER);
                        },
                        list(t) {
                            var e = this.quill.getSelection(),
            ...
            var j = class {
                    ...
                    togglePicker() {
                        this.container.classList.toggle("ql-expanded"),
                            ct(this.label, "aria-expanded"),
                            ct(this.options, "aria-hidden");
                    }
                    buildItem(t) {
                    ...
                    buildOptions() {
                        const n = document.createElement("span");
                        n.classList.add("ql-picker-options"),
                            n.setAttribute("aria-hidden", "true"),
                            (n.tabIndex = "-1"),
                            (n.id = "ql-picker-options-" + at),
                            (at += 1),
                            this.label.setAttribute("aria-controls", n.id),
                            (this.options = n),
                            Array.from(this.select.options).forEach((t) => {
                                var e = this.buildItem(t);
                                n.appendChild(e),
                                    !0 === t.selected && this.selectItem(e);
                            }),
                ...
                v = class {
                    constructor(t, e) {
                        (this.quill = t),
                            ...
                            ((t) => {
                                t = getComputedStyle(t, null).overflowY;
                ...
                C = kt(5374),
                b = kt(9609);
            const dt = [!1, "center", "right", "justify"],
                ft = [
                    "#000000",
                    "#e60000",
                    "#ff9900",
                ...
                pt = [!1, "serif", "monospace"],
                gt = ["1", "2", "3", !1],
                mt = ["small", !1, "large", "huge"];
            class R extends b.A {
                constructor(t, e) {
                    super(t, e);
                    const n = (e) => {
                    ...
                    Array.from(t).forEach((n) => {
                        (n.getAttribute("class") || "")
                            ...
                            .forEach((t) => {
                                var e;
                                t.startsWith("ql-") &&
                                    ((t = t.slice(3)), null != r[t]) &&
                                    ("direction" === t
                                        ? (n.innerHTML = r[t][""] + r[t].rtl)
                                        : "string" == typeof r[t]
                                        ? (n.innerHTML = r[t])
                                        : null != (e = n.value || "") &&
                                          r[t][e] &&
                ...
                buildPickers(t, n) {
                    (this.pickers = Array.from(t).map((t) => {
                        return t.classList.contains("ql-align") &&
                            (null == t.querySelector("option") && I(t, dt),
                            "object" == typeof n.align)
                            ? new ht(t, n.align)
                        ...
                        this.quill.on(C.A.events.EDITOR_CHANGE, () => {
                            this.pickers.forEach((t) => {
                                t.update();
                            });
                        });
                            ...
                            image() {
                                ...
                                null == e &&
                                    ...
                                    e.addEventListener("change", () => {
                                        var t = this.quill.getSelection(!0);
            ...
            function I(n, t, e) {
                let r = 2 < arguments.length && void 0 !== e && e;
                t.forEach((t) => {
            ...
            class At extends bt {
                ...
                constructor(t, e) {
                    super(t, e),
                        this.quill.on(
                            C.A.events.EDITOR_CHANGE,
                            (t, e, n, r) => {
                                if (t === C.A.events.SELECTION_CHANGE)
                                    if (
                                        null != e &&
                                        0 < e.length &&
                                        r === C.A.sources.USER
                ...
                listen() {
                    super.listen(),
                        ...
                        this.quill.on(C.A.events.SCROLL_OPTIMIZE, () => {
                            setTimeout(() => {
                                var t;
                                this.root.classList.contains("ql-hidden") ||
                                    (null != (t = this.quill.getSelection()) &&
                                        null != (t = this.quill.getBounds(t)) &&
                                        this.position(t));
                            }, 1);
                        });
                }
            ...
            class xt extends R {
                constructor(t, e) {
                    null != e.modules.toolbar &&
                        ...
                        (e.modules.toolbar.container = vt),
                        super(t, e),
                        this.quill.container.classList.add("ql-bubble");
                }
                extendToolbar(t) {
                    (this.tooltip = new At(this.quill, this.options.bounds)),
                        null != t.container &&
                            ...
                            (t, e, n) => {
                                if (null != t) {
                                    if (
                                        ...
                                        if (null != e)
                                            return (
                                                (this.linkRange = new yt.Q(
                                                    t.index - n,
                                                    e.length()
                                                )),
                                                (t = g.formats(e.domNode)),
            ...
            class wt extends R {
                constructor(t, e) {
                    null != e.modules.toolbar &&
                        null == e.modules.toolbar.container &&
                        (e.modules.toolbar.container = Nt),
                        super(t, e),
                ...
                extendToolbar(n) {
                    null != n.container &&
                        ...
                        this.buildButtons(
                            n.container.querySelectorAll("button"),
                            T
                        ),
                        this.buildPickers(
                            n.container.querySelectorAll("select"),
                            T
                        ),
                        (this.tooltip = new Et(
                            this.quill,
                                ...
                                if (e) {
                                    ...
                                    if (null != e && 0 !== e.length) {
                                        ...
                                        /^\S+@\S+\.\S+$/.test(t) &&
                                            0 !== t.indexOf("mailto:") &&
                                            (t = "mailto:" + t);
                                        const n = this.quill.theme["tooltip"];
                                        n.edit("link", t);
                                    }
                                } else
                                    this.quill.format(
            ...
            var A = wt,
                qt =
                    (t.default.register(
                        {
                            "attributors/attribute/direction": n.Mc,
                            "attributors/class/align": e.qh,
                            "attributors/class/background": c.l,
                            "attributors/class/color": u.g3,
                            "attributors/class/direction": n.sY,
                            "attributors/class/font": h.q,
                            "attributors/class/size": d.U,
                            "attributors/style/align": e.Hu,
                            "attributors/style/background": c.s,
                            "attributors/style/color": u.JM,
                            "attributors/style/direction": n.VL,
                            "attributors/style/font": h.z,
                            "attributors/style/size": d.r,
                        },
                        !0
                    ),
                    t.default.register(
                        {
                            "formats/align": e.qh,
                            "formats/direction": n.sY,
                            "formats/indent": M,
                            "formats/background": c.s,
                            "formats/color": u.JM,
                            "formats/font": h.q,
                            "formats/size": d.U,
                            "formats/blockquote": D,
                            "formats/code-block": m.Ay,
                            "formats/header": z,
                            "formats/list": a,
                            "formats/bold": p,
                            "formats/code": m.Cy,
                            "formats/italic": class extends p {
                                static blotName = "italic";
                                static tagName = ["EM", "I"];
                            },
                            "formats/link": g,
                            "formats/script": $,
                            "formats/strike": class extends p {
    ...
    function kt(t) {
        ...
        return n[t](e, e.exports, kt), (e.loaded = !0), e.exports;
    }
    var n, r, _t;
});
